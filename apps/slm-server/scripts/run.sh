...
# CHANGE ME before going live: restrict this to the extension's own origin,
# e.g. chrome-extension://<your-extension-id>. See .env.example for details -
# left as "*" here only so first boot isn't blocked before you've installed
# the extension and have its real ID.
